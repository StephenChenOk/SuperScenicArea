...
- (void)initDetailData:(ViewPointItem *)item {
    ...
    self.lbInfo.frame = CGRectMake(3, 551, ceil(labelSize.width-3), ceil(labelSize.height + 100) );
...
- (void)initView {
    [self.view addSubview:({
        ...
        [_scrollView addSubview:({
            _ivImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 414, 250)];
            _ivImage;
        })];
        [_scrollView addSubview:({
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 250, 414, 10)];
            line.backgroundColor = [UIColor colorWithRGB:0xF8F7F7 lpha:1];
            line;
        })];
        [_scrollView addSubview:({
            _lbToday = [[UILabel alloc] initWithFrame:CGRectMake(70, 275, 70, 21)];
            _lbToday.text = @"今日天气";
        ...
        [_scrollView addSubview:({
            _lbTomorrow = [[UILabel alloc] initWithFrame:CGRectMake(278, 275, 70, 21)];
        ...
        [_scrollView addSubview:({
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 310, 414, 1)];
            line.backgroundColor = [UIColor colorWithRGB:0xF8F7F7 lpha:1];
            line;
        })];
        [_scrollView addSubview:({
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(207, 266, 1, 40)];
            line.backgroundColor = [UIColor colorWithRGB:0xF8F7F7 lpha:1];
            line;
        })];
        [_scrollView addSubview:({
            UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(83, 324, 45, 45)];
            image.image = [UIImage imageNamed:@"yin"];
            image;
        })];
        [_scrollView addSubview:({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(88, 375, 35, 21)];
            label.text = @"多云";
            label;
        })];
        [_scrollView addSubview:({
            UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(291, 324, 45, 45)];
            image.image = [UIImage imageNamed:@"temperature"];
            image;
        })];
        [_scrollView addSubview:({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(288, 375, 51, 21)];
            label.text = @"22.1℃";
            label;
        })];
        [_scrollView addSubview:({
            UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(83, 415, 45, 45)];
            image.image = [UIImage imageNamed:@"humidity"];
            image;
        })];
        [_scrollView addSubview:({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(79, 465, 52, 21)];
            label.text = @"72.3 %";
            label;
        })];
        [_scrollView addSubview:({
            UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(291, 415, 40, 40)];
            image.image = [UIImage imageNamed:@"visibility"];
            image;
        })];
        [_scrollView addSubview:({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(266, 465, 95, 21)];
            label.text = @"12860.155m";
            label;
        })];
        [_scrollView addSubview:({
            UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 503, 414, 10)];
            line.backgroundColor = [UIColor colorWithRGB:0xF8F7F7 lpha:1];
            line;
        })];
        [_scrollView addSubview:({
            UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(157, 521, 100, 21)];
            label.text = @"景点简介";
