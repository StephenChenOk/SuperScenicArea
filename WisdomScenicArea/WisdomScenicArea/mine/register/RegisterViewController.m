...
//        self.navigationItem.titleView = titleView;
        ...
        [self.view addSubview:({
            UIImageView *user = [[UIImageView alloc] initWithFrame:UIRect(80, 203, 25, 25)];
            [user setImage:[UIImage imageNamed:@"user"]];
            user;
        })];
        [self.view addSubview:({
            self.account = [[UITextField alloc] initWithFrame:UIRect(122, 202.5, 213, 34)];
        ...
        [self.view addSubview:({
            UIImageView *lock = [[UIImageView alloc] initWithFrame:UIRect(80, 277, 25, 25)];
            [lock setImage:[UIImage imageNamed:@"lock"]];
            lock;
        })];
        [self.view addSubview:({
            self.password = [[UITextField alloc] initWithFrame:UIRect(122, 274.5, 213, 34)];
        ...
        [self.view addSubview:({
            UIImageView *lock = [[UIImageView alloc] initWithFrame:UIRect(80, 347, 25, 25)];
            [lock setImage:[UIImage imageNamed:@"lock"]];
            lock;
        })];
        [self.view addSubview:({
            self.confirmPassword = [[UITextField alloc] initWithFrame:UIRect(122, 344.5, 213, 34)];
        ...
        [self.view addSubview:({
            self.registerBtn = [[UIButton alloc] initWithFrame:UIRect(74, 462, 272, 45)];
            self.registerBtn.titleLabel.font = [UIFont systemFontOfSize:UI(18)];
            ...
            self.registerBtn.layer.cornerRadius = UI(10);
        ...
        [self.view addSubview:({
            UILabel *toRegister = [[UILabel alloc] initWithFrame:UIRect(150, 534, 272, 31)];
